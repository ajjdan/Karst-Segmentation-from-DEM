...
def KaI(n_labels):
    ...
    lay2 = keras.layers.Conv2D(20, (4, 4), activation='relu', padding="same" )(terrain)
    lay3= keras.layers.Conv2D(20, (4, 4), activation='relu', padding="same" )(lay2)
    lay4 = keras.layers.BatchNormalization()(lay3)
    lay5 , mask1 = MaxPoolingWithArgmax2D((2, 2))(lay4)

    lay6= keras.layers.Conv2D(60, (4, 4), activation='relu', padding="same" )(lay5)
    lay7 = keras.layers.Conv2D(60, (4, 4), activation='relu', padding="same" )(lay6)
    lay8 = keras.layers.BatchNormalization()(lay7)
    lay9, mask2 = MaxPoolingWithArgmax2D((2, 2))(lay8)

    lay10 = keras.layers.Conv2D(120, (4, 4), activation='relu', padding="same" )(lay9)
    lay11 = keras.layers.Conv2D(120, (4, 4), activation='relu', padding="same" )(lay10)
    ...
    lay15 = keras.layers.Conv2D(120, (4, 4), activation='relu', padding="same" )(lay14)
    lay16 = keras.layers.Conv2D(120, (4, 4), activation='relu', padding="same" )(lay15)
    lay17 = keras.layers.BatchNormalization()(lay16)

    lay18 = MaxUnpooling2D((2,2))([lay17, mask2])
    lay19 = keras.layers.Conv2D(60, (4, 4), activation='relu', padding="same" )(lay18)
    lay20 = keras.layers.Conv2D(60, (4, 4), activation='relu', padding="same" )(lay19)
    lay21 = keras.layers.BatchNormalization()(lay20)

    lay22 = MaxUnpooling2D((2,2))([lay21, mask1])
    lay23 = keras.layers.Conv2D(20, (4, 4), activation='relu', padding="same" )(lay22)
    lay24 = keras.layers.Conv2D(20, (4, 4), activation='relu', padding="same" )(lay23)
